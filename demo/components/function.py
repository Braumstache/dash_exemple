import pandas as pd
#import des données
df=pd.read_csv("demo/data/prix-carburants-test.csv",sep=';')
...
dftable1=df[['reg_name','dep_code','dep_name','ville','prix_nom','prix_valeur']]
dftable1.rename(columns={"reg_name":"region","dep_code":"code_departement","dep_name":"departement","prix_nom":"carburant","prix_valeur":"prix"},inplace=True)
